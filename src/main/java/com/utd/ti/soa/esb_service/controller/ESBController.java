...
public class ESBController {
    ...
    public ResponseEntity<String> createClient(@RequestBody Object client, 
        ...
        try {
            String response = webClient.post()
                    .uri("http://clients:3000/app/clients/create")
    ...
    public ResponseEntity<String> getClients(@RequestHeader(HttpHeaders.AUTHORIZATION) String token) {
        ...
        String response = webClient.get()
                .uri("http://clients:3000/app/clients/all")
                .header(HttpHeaders.CONTENT_TYPE, MediaType.APPLICATION_JSON_VALUE)
                .retrieve()
                .bodyToMono(String.class)
                .doOnError(error -> System.out.println("Error: " + error.getMessage()))
    ...
    public ResponseEntity<String> updateClient(
        ...
        String response = webClient.patch()
                .uri("http://clients:3000/app/clients/update/" + id)
                .header(HttpHeaders.CONTENT_TYPE, MediaType.APPLICATION_JSON_VALUE)
    ...
    public ResponseEntity<String> deleteClient(
        ...
        String response = webClient.delete()
                .uri("http://clients:3000/app/clients/delete/" + id)
                .header(HttpHeaders.CONTENT_TYPE, MediaType.APPLICATION_JSON_VALUE)
                .retrieve()
                .bodyToMono(String.class)
                .doOnError(error -> System.out.println("Error: " + error.getMessage()))
